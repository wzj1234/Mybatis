		...
		<nav class="navbar navbar-default">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					<li><a class="active">更新数据评估结果</a></li>
...
<style>
        ...
        .downAskResClass{position:relative; width:260px;  left:23px; top:8px} 
        .downAllResClass{ position:relative; width:150px; left:23px; top:64px} 
        .checkBoxClass{ position:relative;left:25px; } 
        .downConclusionClass{position:relative; width:260px; height:30px;  left:323px; top:-26px} 
        .checkElements {
            width: 98%;
            color: #68b068;   
...
<br>
		 	...
		 	<form action="downloadAllCalResultNorUser">
		 	...
		 	<form action="downloadAskCalResultNorUser">
			...
			<form action="downloadConclusionNorUser">
